...
const SuggestionDetailsCard: FC<SuggestionDetailsCardProps> = ({ item, userId }) => {
  if (!item) return null;
    ...
    <View style={styles.container}>
        ...
        {isOwner && (
          <View style={styles.actionButtons}>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <MaterialCommunityIcons name="file-edit-outline" size={20} color={Colors.primary} />
            </TouchableOpacity>
            <TouchableOpacity
      ...
      <Text
        style={[
          ...
          {
            color: isActive || item?.status === 'approved' ? Colors.primary : Colors.error,
          },
        ]}
      >
        {item?.status === 'open'
      ...
      <View style={styles.detailRow}>
        ...
        <Text style={styles.detailValue}>{item?.invitationCode.substring(0, 15)}...</Text>
        <TouchableOpacity
      ...
      <View style={styles.progressWrapper}>
        ...
        <View style={styles.progressFooter}>
          {item.status === 'open' && (
            <TouchableOpacity activeOpacity={0.8} onPress={handleLike} hitSlop={10}>
              <Ionicons
