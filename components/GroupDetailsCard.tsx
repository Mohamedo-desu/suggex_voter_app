...
const GroupDetailsCard = ({ item, openImagePickerSheet }: GroupDetailsCardProps) => {
  if (!item) return null;
  ...
  return (
    <View style={styles.listHeaderContainer}>
        ...
        {role === 'owner' && (
          <View style={styles.actionButtons}>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <MaterialCommunityIcons name="file-edit-outline" size={24} color={Colors.primary} />
            </TouchableOpacity>
            {deleting ? (
      ...
      <View style={styles.detailRow}>
        ...
        <Text style={styles.detailValue}>{invitationCode.substring(0, 15)}...</Text>
        <TouchableOpacity
